...
move(s([E1, E2, E3], 'L', []), s([E1, E2], 'R', [E3])) :- not(listIsDead([E1, E2])).
move(s([E1, E2, E3], 'L', []), s([E1, E3], 'R', [E2])) :- not(listIsDead([E1, E3])).
move(s([E1, E2, E3], 'L', []), s([E2, E3], 'R', [E1])) :- not(listIsDead([E2, E3])).

move(s([L|T], 'R', R), s([L|T], 'L', R)) :- not(listIsDead(R)).
move(s(L, 'R', [E1, E2]), s(RES, 'L', [E2])) :- listIsDead([E1, E2]), push_back(E1, L, RES).
